...
export default function MyLinks() {
  return (
    <div className='bg-blue-100'>
       <div
      className="bg-[#f5f5f5] px-5 md:px-10 py-10 flex flex-col gap-10"
      // style={{ height: `calc(100vh - 84px)` }}
    >
      <div className="flex flex-col gap-2">
        <div className="text-2xl text-zinc-400">Good Evening</div>
      ...
      <div className=" bg-white rounded-lg flex flex-col gap-6 items-center justify-center py-16">
        <div className="">
        ...
        <div className="text-blue-600 font-semibold cursor-pointer">Create</div>
      </div>
      ...
      <div className="flex items-center gap-1 font-semibold tracking-wide text-white bg-blue-600 fixed py-2 px-4 rounded-3xl shadow-lg  shadow-blue-500 bottom-10 right-5 lg:hidden">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"

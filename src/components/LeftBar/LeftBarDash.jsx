...
import { leftDashData } from "./LeftDash";

export default function LeftBarDash({ setSelectedLink }) {
  ...
  return (
    <div className="h-auto w-[316px] hidden lg:flex">
      <div className="px-5 bg-white py-6 h-auto min-h-screen w-full flex flex-col gap-6 mt-1">
        <div className="px-4">
          <svg
            width="123"
            height="24"
        ...
        <div className="bg-[#e7e9fe] w-full h-auto rounded-lg flex flex-col items-center justify-center gap-5 py-4">
          ...
          <div className="flex gap-4">
            <div className="bg-black flex items-center gap-1 p-2 rounded-lg">
              <img src="./images/play.png" className="h-7" alt="" />
              <div className="">
                <div className="text-[9px] text-zinc-400">GET IT ON</div>
                <div className="text-white text-[11px]">Google Play</div>
              </div>
            </div>
            <div className="bg-black flex items-center gap-1 p-2 rounded-lg">
              <img src="./images/appledash.png" className="h-7" alt="" />
              <div className="">
                <div className="text-[9px] text-zinc-400">GET IT ON</div>
                <div className="text-white text-[11px]">Apple Store</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <div className="flex gap-5">
            <div className="bg-[#ffe9ec] p-2 rounded-lg">
              <img src="./images/insta.png" className="h-5" alt="" />
            </div>
            <div className="bg-[#e2edff] p-2 rounded-lg">
              <img src="./images/facebook.png" className="h-5" alt="" />
            </div>
            <div className="bg-[#e9f9ff] p-2 rounded-lg">
              <img src="./images/tweet.png" className="h-5" alt="" />
            </div>
            <div className="bg-[#e0eff6] p-2 rounded-lg">
